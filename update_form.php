...
<body>
    ...
    <form action="blog_update.php" method="POST">
        ...
        <br>
        <input type="radio" name="publich_status" value="1" "checked" <?php if($publich_status == 1) echo "checked"?>checked>公開
        <input type="radio" name="publich_status" value="2" <?php if($publich_status == 2) echo "checked"?>>非公開
        <br>
